...
def sendMail(sendTo, msg):
    ...
    mail.login(usermail, password)  # login part
    for person in sendTo:
        mail.sendmail(usermail, person, msg)  # send part
...
def getMailBoxStatus():
    ...
    M.login(usermail, password)  # login
